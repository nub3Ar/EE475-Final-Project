...
# Adopted from https://github.com/teelinsan/KerasDropconnect/blob/master/ddrop/layers.py
...
class DropConnect(Wrapper):
    ...
    def call(self, x):
        if 0. < self.prob < 1.:
            self.layer.kernel = K.in_train_phase(K.dropout(self.layer.kernel, self.prob) * (1 - self.prob),
                                                 self.layer.kernel)
